"""
Risk Detector Spark Streaming Job - Local version without AWS IAM auth.
...
def write_risk_signals(risk_signals_df):
    """Write risk signals to Kafka - PLAINTEXT, no IAM auth"""
...
def write_kill_commands(kill_commands_df):
    """Write kill commands to Kafka - PLAINTEXT, no IAM auth"""
